...
-- İleri/geri tuşları → tarayıcı geçmişi gibi workspace geçişi
hl.bind("mouse:276", hl.dsp.focus({ workspace = "e+1" }))  -- ileri
hl.bind("mouse:275", hl.dsp.focus({ workspace = "e-1" }))  -- geri